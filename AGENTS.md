...
### 0.0.3.0 ASSISTANT_TURN_EXIT_HARD_GATE_V2
...
4. `BLOCKED` 只有符合 canonical controller Skill 的 genuine external authority/capability blocker 才可 turn-exit；它仍不得通過 `assert-finalizable`。
