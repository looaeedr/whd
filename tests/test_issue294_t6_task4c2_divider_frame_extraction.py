...
def test_task4c2_root_keeps_assembly_derivation_and_placement_authority():
    source, methods = _host_methods()
    name = "_door_layout_divider_frame_snapshot"
    assert name in methods, "T6 TASK4C2 RED: divider/frame snapshot builder missing"
