...
MAXIMAL_T4_UPPER_BOUND_METHODS = {
    ...
    "_set_box_assembly_type",
    "on_box_assembly_changed",
    "_effective_endcap_fw",
    "_sync_endcap_fw_controls",
    "_apply_endcap_fw_snapshot",
    "on_endcap_fw_follow_changed",
    "on_fw_selected",
    "_baseline_source_model",
    "_door_material_frame_width",
    "_sync_fold_designer_manual_corner_context",
    "_current_manual_corner_part_key",
    "_manual_corner_policy",
    "_box_body_corner_policies",
    "_phase6_resolved_finished_dimensions",
    "_draw_phase6_finished_dimension_summary",
    "_box_body_finished_height",
    "_fixed_corner_summary",
    "_corner_part_type_editable",
    "_corner_part_editable",
    "_corner_part_parameters_unlockable",
    "_manual_corner_parameters_unlocked",
    "_manual_corner_parameters_editable",
    ...
    "_pair_for_corner_target",
    "_normalize_manual_corner_target",
    "_manual_selection_for_target",
    "select_manual_corner",
    "on_manual_corner_pair_same_changed",
    "set_manual_corner_type",
    "_corner_number_text",
    "_selection_from_manual_corner_controls",
    "on_manual_corner_mode_changed",
    "on_manual_corner_parameter_changed",
    "_refresh_manual_corner_parameter_rows",
    "refresh_corner_type_panel",
    "on_base_plate_same_toggle",
    ...
    "setup_tab_z_ui",
    "_render_fold_designer_corner_data_view",
    "_attach_part_hole_entrypoint",
    "setup_tab_endcap_ui",
    "setup_tab_base_plate_ui",
    "_door_layout_number_text",
    "_new_door_layout_column",
    "set_door_layout_columns",
    "_ensure_door_layout_default",
    "_parse_layout_value",
    "_recompute_column_height_remainder",
    "_recompute_door_layout_remainders",
    "get_door_layout_columns",
    "get_door_layout_cells",
    "_door_layout_cell_key",
    "get_selected_door_layout_cell",
    "select_door_layout_cell",
    "_sync_door_canvas_double_click_binding",
    "toggle_multi_door_layout",
    "_reject_door_layout_dimension",
    "commit_door_layout_width",
    "commit_door_layout_height",
    "add_door_layout_column",
    "_remap_door_layout_owned_data",
    "remove_door_layout_column",
    "add_door_layout_height",
    ...
    "_receiving_inner_door_inward_offset",
    "_set_receiving_inner_door_inward_offset",
    "_commit_receiving_inner_door_inward_offset",
    "_set_receiving_inner_door_enabled",
    "_commit_receiving_inner_door_checkbox",
    "refresh_door_layout_status",
    "rebuild_door_layout_ui",
    "setup_tab_door_ui",
    "setup_tab_indicator_box_ui",
    "on_layers_count_changed",
    "rebuild_layers_config_ui",
    "_normalize_door_indicator_state",
    "_door_layout_indicator_state_for_key",
    "on_double_click_indicator",
...
def test_issue292_raw_5500_gate_is_reachable_without_stealing_later_scope():
    ...
    assert MAXIMAL_T4_UPPER_BOUND_METHODS.isdisjoint(EXPLICIT_LATER_SLICE_METHODS)
    ...
    assert zero_wiring_best_case <= RAW_ISSUE_GATE, (
        "#292 raw gui.py<=5500 gate is not legally reachable from accepted "
        f"predecessor {ACCEPTED_PREDECESSOR}: current_loc={current_loc}, "
        f"maximal_T4_upper_bound_removable={maximal_removable_loc}, "
        f"zero_wiring_best_case={zero_wiring_best_case}, gate={RAW_ISSUE_GATE}. "
        "This bound already over-credits all of mixed init_variables to T4 and "
        "assumes zero delegate/import wiring. Reconcile the gate before extraction; "
        "do not steal T5/T6/T7/HOLD scope."
    )
