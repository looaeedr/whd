#!/usr/bin/env python3
"""#367 T3 task-scoped A/B classifier.

Compares relevant Project / Persistence / Status / Output outcomes between the immutable
T2 baseline and one candidate. The classifier is fail-closed on assigned node
sets, per-node outcomes, errors, and protected config/DXF digests.
"""
...
def main() -> int:
    ...
    payload = {
        ...
        "classifier": {
            ...
            "UNEXPLAINED_PERSISTENCE_DELTA": 1 if unexplained else 0,
        },
    }
    ...
    print("ISSUE367_T3_AB_DECISION=GREEN")
    return 0
