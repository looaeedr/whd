#!/usr/bin/env python3
"""#366 T2 task-scoped A/B classifier.

Compares relevant Settings / Corner / Structure outcomes between the immutable
...
def main() -> int:
    ...
    print("ISSUE366_T2_AB_DECISION=GREEN")
    return 0
