#!/usr/bin/env python3
"""#370 T6 task-scoped A/B classifier."""
...
def main() -> int:
    ...
    classifier = {
        "NEW_RELEVANT_HEADLESS": headless["new_failed"],
        "NEW_RELEVANT_XVFB": xvfb["new_failed"],
    ...
    decision = "GREEN" if (
        ...
        and classifier["UNEXPLAINED_3D_DELTA"] == 0
    ) else "RED"
    payload = {
        "schema": "WHD_ISSUE370_T6_AB_V1",
        "decision": decision,
        "headless": headless,
        "xvfb": xvfb,
        "protected": protected,
    ...
    print("ISSUE370_T6_AB_DECISION=GREEN")
    return 0
